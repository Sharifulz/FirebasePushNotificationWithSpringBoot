...
public class PushNotificationController {
	...
	public ResponseEntity sendNotification(@RequestBody PushNotificationRequest request) {
		...
		return new ResponseEntity<>(
				new PushNotificationResponse(HttpStatus.OK.value(), "Notification has been sent. 1"), HttpStatus.OK);
	}
	...
	public ResponseEntity sendTokenNotification(@RequestBody PushNotificationRequest request) {
		...
		return new ResponseEntity<>(
				new PushNotificationResponse(HttpStatus.OK.value(), "Notification has been sent. 2"), HttpStatus.OK);
	}
	...
	public ResponseEntity sendDataNotification(@RequestBody PushNotificationRequest request) {
		...
		return new ResponseEntity<>(
				new PushNotificationResponse(HttpStatus.OK.value(), "Notification has been sent. 3"), HttpStatus.OK);
	}
	...
	public ResponseEntity sendDataNotificationCustom(@RequestBody PushNotificationRequest request) {
		...
		return new ResponseEntity<>(
				new PushNotificationResponse(HttpStatus.OK.value(), "Notification has been sent. 4"), HttpStatus.OK);
	}
	...
	public ResponseEntity sendDataNotificationCustomWithSpecificJson(@RequestBody PushNotificationRequest request) {
		...
		return new ResponseEntity<>(
				new PushNotificationResponse(HttpStatus.OK.value(), "Notification has been sent. 5"), HttpStatus.OK);
	}

	public void sendAutomaticNotification() {
		PushNotificationRequest request = new PushNotificationRequest();
		request.setTopic("mango");
		pushNotificationService.sendPushNotificationCustomDataWithTopicWithSpecificJson(request);
	}
}