...
public class PushNotificationService {
	...
	private Map<String, String> getSamplePayloadDataWithSpecificJsonFormat() {
		...
		/*
		 * getPreconfiguredMessageBuilderCustomDataWithTopic will get some issue to
		 * generate notification as data.get("title") wont give us title as its mapped
		 * inside data
		 */
	}
